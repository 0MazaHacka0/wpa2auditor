...
<form enctype="multipart/form-data" id="formUploadHandshake">
            ...
            <tr>
                <td>
                    <input type="submit" class="btn btn-primary" value="Upload files"
                           name="buttonUploadFile" id="buttonUploadFile">
                </td>
            </tr>
...
<h2>NTLM Hash</h2>
<form enctype="multipart/form-data" id="formUploadNTLMHash">
    <input type="hidden" name="source" value="upload">
    <input type="hidden" name="action" value="addfile">
    <div class="panel panel-default">
        <table class="table table-bordered table-nonfluid" id="tableUploadHash">
            ...
            <tr>
                <td>
                    <input type="submit" class="btn btn-primary" value="Upload hash" name="buttonUploadHash"
                           id="buttonUploadHash">
                </td>
            </tr>
            </tbody>
